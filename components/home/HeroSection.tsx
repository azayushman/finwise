  ...
  return (
    ...
    >
      ...
      <div aria-hidden="true" className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-24 right-0 w-[500px] h-[500px] rounded-full opacity-20 animate-float"
             style={{ background: "radial-gradient(circle, #00C896, transparent 70%)", filter: "blur(80px)" }} />
        <div className="absolute bottom-0 -left-20 w-[400px] h-[400px] rounded-full opacity-15 animate-float delay-300"
             style={{ background: "radial-gradient(circle, #2E5F9A, transparent 70%)", filter: "blur(100px)", animationDelay: "2.5s" }} />
        <div className="absolute top-1/3 left-1/2 w-[200px] h-[200px] rounded-full opacity-10 animate-float"
             style={{ background: "radial-gradient(circle, #00C896, transparent 70%)", filter: "blur(60px)", animationDelay: "1.2s" }} />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center w-full">
        ...
        <div>
          ...
          <div className="flex flex-wrap items-center gap-6 animate-slide-up delay-400" aria-label="Platform statistics">
            {[
              ...
              { value: "120+",  label: "Finance Topics" },
        ...
        <div className="flex justify-center lg:justify-end animate-slide-up delay-200" aria-hidden="true">
          <div
            className="w-full max-w-[460px] rounded-2xl p-6 shadow-[0_25px_60px_rgba(0,0,0,0.35)]"
            ...
            <div className="h-16 mb-6 rounded-lg overflow-hidden">
              <svg viewBox="0 0 380 70" preserveAspectRatio="none" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M0,55 C30,50 50,45 80,38 C110,31 130,35 160,28 C190,21 210,30 240,18 C270,6 300,12 330,8 C355,4 370,10 380,5 L380,70 L0,70 Z"
                      fill="url(#sparkGrad)" />
                <circle cx="240" cy="18" r="3" fill="#00C896" />
                <circle cx="380" cy="5"  r="4" fill="#00C896" />
              </svg>
            </div>
